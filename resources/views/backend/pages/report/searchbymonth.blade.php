...
@section('admin_content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
              <h2 class="mt-2">Search By Month Orders</h2>
                <div class="card pd-20 pd-sm-40 mg-t-50 mb-3">
                  <div><h2 class="text-info">Month Total Selling Price: {{$total}}৳</h2></div>
                    <div class="table-wrapper">
                        ...
                        <table id="datatable1" class="table display responsive nowrap text-center table-bordered">
                          <thead>
                            <tr>
                              ...
                              <th class="wd-20p">Order Month</th>
                        ...
                        <div class="alert alert-primary" role="alert">
                          <h1 class="text-center">Empty Month Orders</h1>
                        </div>
                      @endif 
                    </div>
