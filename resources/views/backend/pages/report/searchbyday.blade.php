...
@section('admin_content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
              <h2 class="mt-2">Search By Day Orders</h2>
                <div class="card pd-20 pd-sm-40 mg-t-50 mb-3">
                  <div><h2 class="text-info">Today Total Selling Price: {{$total}}৳</h2></div>
                    <div class="table-wrapper">
                        ...
                        <div class="alert alert-primary" role="alert">
                          <h1 class="text-center">Empty Today Orders</h1>
                        </div>
                      @endif 
                    </div>
